...
#Create fake presence/absence data for each datapoint
...
bioclimLC1<-crop(x=bioclimLC, extent(-75, -67, 40, 46)) 


# cropping to New England extent
plot(bioclimLC1)
